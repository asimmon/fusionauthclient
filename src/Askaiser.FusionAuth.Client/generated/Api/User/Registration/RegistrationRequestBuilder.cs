// <auto-generated/>
using Askaiser.FusionAuth.Client.Api.User.Registration.Item;
...
using System;
namespace Askaiser.FusionAuth.Client.Api.User.Registration {
    /// <summary>
    ...
    public class RegistrationRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Askaiser.FusionAuth.Client.api.user.registration.item collection</summary>
...
#nullable restore
        ...
        public class RegistrationRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
