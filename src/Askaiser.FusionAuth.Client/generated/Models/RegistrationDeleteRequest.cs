...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class RegistrationDeleteRequest : IParsable {
...
#nullable restore
        ...
        public static RegistrationDeleteRequest CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new RegistrationDeleteRequest();
        }
        /// <summary>
