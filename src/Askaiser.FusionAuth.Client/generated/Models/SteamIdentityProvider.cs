...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class SteamIdentityProvider : IParsable {
        /// <summary>Steam API modes.</summary>
        public SteamAPIMode? ApiMode { get; set; }
        /// <summary>The applicationConfiguration property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SteamIdentityProvider_applicationConfiguration? ApplicationConfiguration { get; set; }
#nullable restore
#else
        public SteamIdentityProvider_applicationConfiguration ApplicationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SteamIdentityProvider_data? Data { get; set; }
#nullable restore
#else
        public SteamIdentityProvider_data Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SteamIdentityProvider_tenantConfiguration? TenantConfiguration { get; set; }
#nullable restore
#else
        public SteamIdentityProvider_tenantConfiguration TenantConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public static SteamIdentityProvider CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"apiMode", n => { ApiMode = n.GetEnumValue<SteamAPIMode>(); } },
                {"applicationConfiguration", n => { ApplicationConfiguration = n.GetObjectValue<SteamIdentityProvider_applicationConfiguration>(SteamIdentityProvider_applicationConfiguration.CreateFromDiscriminatorValue); } },
                {"buttonText", n => { ButtonText = n.GetStringValue(); } },
                {"client_id", n => { ClientId = n.GetStringValue(); } },
                {"data", n => { Data = n.GetObjectValue<SteamIdentityProvider_data>(SteamIdentityProvider_data.CreateFromDiscriminatorValue); } },
                ...
                {"tenantConfiguration", n => { TenantConfiguration = n.GetObjectValue<SteamIdentityProvider_tenantConfiguration>(SteamIdentityProvider_tenantConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<SteamAPIMode>("apiMode", ApiMode);
            writer.WriteObjectValue<SteamIdentityProvider_applicationConfiguration>("applicationConfiguration", ApplicationConfiguration);
            writer.WriteStringValue("buttonText", ButtonText);
            writer.WriteStringValue("client_id", ClientId);
            writer.WriteObjectValue<SteamIdentityProvider_data>("data", Data);
            ...
            writer.WriteObjectValue<SteamIdentityProvider_tenantConfiguration>("tenantConfiguration", TenantConfiguration);
