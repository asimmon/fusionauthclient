...
namespace Askaiser.FusionAuth.Client.Models {
    public class LinkedInIdentityProvider : IParsable {
        /// <summary>The applicationConfiguration property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public LinkedInIdentityProvider_applicationConfiguration? ApplicationConfiguration { get; set; }
#nullable restore
#else
        public LinkedInIdentityProvider_applicationConfiguration ApplicationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public LinkedInIdentityProvider_data? Data { get; set; }
#nullable restore
#else
        public LinkedInIdentityProvider_data Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public LinkedInIdentityProvider_tenantConfiguration? TenantConfiguration { get; set; }
#nullable restore
#else
        public LinkedInIdentityProvider_tenantConfiguration TenantConfiguration { get; set; }
#endif
        ...
        public static LinkedInIdentityProvider CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"applicationConfiguration", n => { ApplicationConfiguration = n.GetObjectValue<LinkedInIdentityProvider_applicationConfiguration>(LinkedInIdentityProvider_applicationConfiguration.CreateFromDiscriminatorValue); } },
                {"buttonText", n => { ButtonText = n.GetStringValue(); } },
                {"client_id", n => { ClientId = n.GetStringValue(); } },
                {"client_secret", n => { ClientSecret = n.GetStringValue(); } },
                {"data", n => { Data = n.GetObjectValue<LinkedInIdentityProvider_data>(LinkedInIdentityProvider_data.CreateFromDiscriminatorValue); } },
                ...
                {"tenantConfiguration", n => { TenantConfiguration = n.GetObjectValue<LinkedInIdentityProvider_tenantConfiguration>(LinkedInIdentityProvider_tenantConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<LinkedInIdentityProvider_applicationConfiguration>("applicationConfiguration", ApplicationConfiguration);
            writer.WriteStringValue("buttonText", ButtonText);
            writer.WriteStringValue("client_id", ClientId);
            writer.WriteStringValue("client_secret", ClientSecret);
            writer.WriteObjectValue<LinkedInIdentityProvider_data>("data", Data);
            ...
            writer.WriteObjectValue<LinkedInIdentityProvider_tenantConfiguration>("tenantConfiguration", TenantConfiguration);
