...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Entity_data? Data { get; set; }
#nullable restore
#else
        public Entity_data Data { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetObjectValue<Entity_data>(Entity_data.CreateFromDiscriminatorValue); } },
                ...
                {"type", n => { Type = n.GetObjectValue<EntityType>(EntityType.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Entity_data>("data", Data);
            ...
            writer.WriteObjectValue<EntityType>("type", Type);
        }
    }
}
