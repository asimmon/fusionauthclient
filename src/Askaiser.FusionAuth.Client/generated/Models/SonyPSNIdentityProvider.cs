...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class SonyPSNIdentityProvider : IParsable {
        /// <summary>The applicationConfiguration property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SonyPSNIdentityProvider_applicationConfiguration? ApplicationConfiguration { get; set; }
#nullable restore
#else
        public SonyPSNIdentityProvider_applicationConfiguration ApplicationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SonyPSNIdentityProvider_data? Data { get; set; }
#nullable restore
#else
        public SonyPSNIdentityProvider_data Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SonyPSNIdentityProvider_tenantConfiguration? TenantConfiguration { get; set; }
#nullable restore
#else
        public SonyPSNIdentityProvider_tenantConfiguration TenantConfiguration { get; set; }
#endif
        ...
        public static SonyPSNIdentityProvider CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"applicationConfiguration", n => { ApplicationConfiguration = n.GetObjectValue<SonyPSNIdentityProvider_applicationConfiguration>(SonyPSNIdentityProvider_applicationConfiguration.CreateFromDiscriminatorValue); } },
                {"buttonText", n => { ButtonText = n.GetStringValue(); } },
                {"client_id", n => { ClientId = n.GetStringValue(); } },
                {"client_secret", n => { ClientSecret = n.GetStringValue(); } },
                {"data", n => { Data = n.GetObjectValue<SonyPSNIdentityProvider_data>(SonyPSNIdentityProvider_data.CreateFromDiscriminatorValue); } },
                ...
                {"tenantConfiguration", n => { TenantConfiguration = n.GetObjectValue<SonyPSNIdentityProvider_tenantConfiguration>(SonyPSNIdentityProvider_tenantConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<SonyPSNIdentityProvider_applicationConfiguration>("applicationConfiguration", ApplicationConfiguration);
            writer.WriteStringValue("buttonText", ButtonText);
            writer.WriteStringValue("client_id", ClientId);
            writer.WriteStringValue("client_secret", ClientSecret);
            writer.WriteObjectValue<SonyPSNIdentityProvider_data>("data", Data);
            ...
            writer.WriteObjectValue<SonyPSNIdentityProvider_tenantConfiguration>("tenantConfiguration", TenantConfiguration);
