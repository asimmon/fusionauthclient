...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class EpicGamesIdentityProvider : IParsable {
        /// <summary>The applicationConfiguration property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public EpicGamesIdentityProvider_applicationConfiguration? ApplicationConfiguration { get; set; }
#nullable restore
#else
        public EpicGamesIdentityProvider_applicationConfiguration ApplicationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public EpicGamesIdentityProvider_data? Data { get; set; }
#nullable restore
#else
        public EpicGamesIdentityProvider_data Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public EpicGamesIdentityProvider_tenantConfiguration? TenantConfiguration { get; set; }
#nullable restore
#else
        public EpicGamesIdentityProvider_tenantConfiguration TenantConfiguration { get; set; }
#endif
        ...
        public static EpicGamesIdentityProvider CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"applicationConfiguration", n => { ApplicationConfiguration = n.GetObjectValue<EpicGamesIdentityProvider_applicationConfiguration>(EpicGamesIdentityProvider_applicationConfiguration.CreateFromDiscriminatorValue); } },
                {"buttonText", n => { ButtonText = n.GetStringValue(); } },
                {"client_id", n => { ClientId = n.GetStringValue(); } },
                {"client_secret", n => { ClientSecret = n.GetStringValue(); } },
                {"data", n => { Data = n.GetObjectValue<EpicGamesIdentityProvider_data>(EpicGamesIdentityProvider_data.CreateFromDiscriminatorValue); } },
                ...
                {"tenantConfiguration", n => { TenantConfiguration = n.GetObjectValue<EpicGamesIdentityProvider_tenantConfiguration>(EpicGamesIdentityProvider_tenantConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<EpicGamesIdentityProvider_applicationConfiguration>("applicationConfiguration", ApplicationConfiguration);
            writer.WriteStringValue("buttonText", ButtonText);
            writer.WriteStringValue("client_id", ClientId);
            writer.WriteStringValue("client_secret", ClientSecret);
            writer.WriteObjectValue<EpicGamesIdentityProvider_data>("data", Data);
            ...
            writer.WriteObjectValue<EpicGamesIdentityProvider_tenantConfiguration>("tenantConfiguration", TenantConfiguration);
