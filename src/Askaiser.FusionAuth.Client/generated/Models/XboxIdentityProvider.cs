...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class XboxIdentityProvider : IParsable {
        /// <summary>The applicationConfiguration property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public XboxIdentityProvider_applicationConfiguration? ApplicationConfiguration { get; set; }
#nullable restore
#else
        public XboxIdentityProvider_applicationConfiguration ApplicationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public XboxIdentityProvider_data? Data { get; set; }
#nullable restore
#else
        public XboxIdentityProvider_data Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public XboxIdentityProvider_tenantConfiguration? TenantConfiguration { get; set; }
#nullable restore
#else
        public XboxIdentityProvider_tenantConfiguration TenantConfiguration { get; set; }
#endif
        ...
        public static XboxIdentityProvider CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"applicationConfiguration", n => { ApplicationConfiguration = n.GetObjectValue<XboxIdentityProvider_applicationConfiguration>(XboxIdentityProvider_applicationConfiguration.CreateFromDiscriminatorValue); } },
                {"buttonText", n => { ButtonText = n.GetStringValue(); } },
                {"client_id", n => { ClientId = n.GetStringValue(); } },
                {"client_secret", n => { ClientSecret = n.GetStringValue(); } },
                {"data", n => { Data = n.GetObjectValue<XboxIdentityProvider_data>(XboxIdentityProvider_data.CreateFromDiscriminatorValue); } },
                ...
                {"tenantConfiguration", n => { TenantConfiguration = n.GetObjectValue<XboxIdentityProvider_tenantConfiguration>(XboxIdentityProvider_tenantConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<XboxIdentityProvider_applicationConfiguration>("applicationConfiguration", ApplicationConfiguration);
            writer.WriteStringValue("buttonText", ButtonText);
            writer.WriteStringValue("client_id", ClientId);
            writer.WriteStringValue("client_secret", ClientSecret);
            writer.WriteObjectValue<XboxIdentityProvider_data>("data", Data);
            ...
            writer.WriteObjectValue<XboxIdentityProvider_tenantConfiguration>("tenantConfiguration", TenantConfiguration);
