...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class GroupResponse : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Askaiser.FusionAuth.Client.Models.Group>? Groups { get; set; }
#nullable restore
#else
        public List<Askaiser.FusionAuth.Client.Models.Group> Groups { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"groups", n => { Groups = n.GetCollectionOfObjectValues<Askaiser.FusionAuth.Client.Models.Group>(Askaiser.FusionAuth.Client.Models.Group.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Askaiser.FusionAuth.Client.Models.Group>("groups", Groups);
        }
    }
}
