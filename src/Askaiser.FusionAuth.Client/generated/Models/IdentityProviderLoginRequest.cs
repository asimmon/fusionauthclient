...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class IdentityProviderLoginRequest : IParsable {
        /// <summary>The applicationId property</summary>
        public Guid? ApplicationId { get; set; }
        /// <summary>The data property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public IdentityProviderLoginRequest_data? Data { get; set; }
#nullable restore
#else
        public IdentityProviderLoginRequest_data Data { get; set; }
#endif
...
#nullable restore
        ...
        public static IdentityProviderLoginRequest CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IdentityProviderLoginRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetObjectValue<IdentityProviderLoginRequest_data>(IdentityProviderLoginRequest_data.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<IdentityProviderLoginRequest_data>("data", Data);
