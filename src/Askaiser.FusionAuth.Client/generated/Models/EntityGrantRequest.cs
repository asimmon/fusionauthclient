...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class EntityGrantRequest : IParsable {
...
#nullable restore
        ...
        public static EntityGrantRequest CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EntityGrantRequest();
        }
        /// <summary>
