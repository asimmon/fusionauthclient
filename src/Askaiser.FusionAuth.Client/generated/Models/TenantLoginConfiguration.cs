...
namespace Askaiser.FusionAuth.Client.Models {
    public class TenantLoginConfiguration : IParsable {
        ...
        public static TenantLoginConfiguration CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TenantLoginConfiguration();
        }
        /// <summary>
