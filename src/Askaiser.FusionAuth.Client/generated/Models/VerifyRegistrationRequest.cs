...
namespace Askaiser.FusionAuth.Client.Models {
    public class VerifyRegistrationRequest : IParsable {
...
#nullable restore
        ...
        public static VerifyRegistrationRequest CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new VerifyRegistrationRequest();
        }
        /// <summary>
