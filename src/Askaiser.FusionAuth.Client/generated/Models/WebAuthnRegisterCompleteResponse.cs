...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class WebAuthnRegisterCompleteResponse : IParsable {
...
#nullable restore
        ...
        public static WebAuthnRegisterCompleteResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WebAuthnRegisterCompleteResponse();
        }
        /// <summary>
