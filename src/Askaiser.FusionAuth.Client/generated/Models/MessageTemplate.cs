...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class MessageTemplate : IParsable {
        /// <summary>The data property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public MessageTemplate_data? Data { get; set; }
#nullable restore
#else
        public MessageTemplate_data Data { get; set; }
#endif
...
#nullable restore
        ...
        public static MessageTemplate CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<MessageTemplate_data>(MessageTemplate_data.CreateFromDiscriminatorValue); } },
                {"id", n => { Id = n.GetGuidValue(); } },
                {"insertInstant", n => { InsertInstant = n.GetLongValue(); } },
                {"lastUpdateInstant", n => { LastUpdateInstant = n.GetLongValue(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"type", n => { Type = n.GetEnumValue<MessageType>(); } },
            };
        }
        /// <summary>
