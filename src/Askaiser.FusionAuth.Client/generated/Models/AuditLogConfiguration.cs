...
namespace Askaiser.FusionAuth.Client.Models {
    public class AuditLogConfiguration : IParsable {
...
#nullable restore
        ...
        public static AuditLogConfiguration CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AuditLogConfiguration();
        }
        /// <summary>
