...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class GoogleIdentityProviderProperties : IParsable {
...
#nullable restore
        ...
        public static GoogleIdentityProviderProperties CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GoogleIdentityProviderProperties();
        }
        /// <summary>
