...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class FamilyEmailRequest : IParsable {
...
#nullable restore
        ...
        public static FamilyEmailRequest CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new FamilyEmailRequest();
        }
        /// <summary>
