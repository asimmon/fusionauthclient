...
namespace Askaiser.FusionAuth.Client.Models {
    ...
    /// </summary>
    public class UserCommentSearchCriteria : IParsable {
...
#nullable restore
        ...
        public static UserCommentSearchCriteria CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserCommentSearchCriteria();
        }
        /// <summary>
