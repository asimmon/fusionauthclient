...
namespace Askaiser.FusionAuth.Client.Models {
    public class CORSConfiguration : IParsable {
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"allowedMethods", n => { AllowedMethods = n.GetCollectionOfEnumValues<HTTPMethod>()?.ToList(); } },
                {"allowedOrigins", n => { AllowedOrigins = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"debug", n => { Debug = n.GetBoolValue(); } },
                {"enabled", n => { Enabled = n.GetBoolValue(); } },
                {"exposedHeaders", n => { ExposedHeaders = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfEnumValues<HTTPMethod>("allowedMethods", AllowedMethods);
