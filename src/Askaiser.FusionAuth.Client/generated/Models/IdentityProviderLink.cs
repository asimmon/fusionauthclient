...
namespace Askaiser.FusionAuth.Client.Models {
    public class IdentityProviderLink : IParsable {
        /// <summary>The data property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public IdentityProviderLink_data? Data { get; set; }
#nullable restore
#else
        public IdentityProviderLink_data Data { get; set; }
#endif
...
#nullable restore
        ...
        public static IdentityProviderLink CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IdentityProviderLink();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<IdentityProviderLink_data>(IdentityProviderLink_data.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<IdentityProviderLink_data>("data", Data);
