...
namespace Askaiser.FusionAuth.Client.Models {
    public class EmailConfiguration : IParsable {
...
#nullable restore
        ...
        public EmailSecurityType? Security { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public EmailUnverifiedOptions? Unverified { get; set; }
#nullable restore
#else
        public EmailUnverifiedOptions Unverified { get; set; }
#endif
...
#nullable restore
        ...
        public static EmailConfiguration CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"additionalHeaders", n => { AdditionalHeaders = n.GetCollectionOfObjectValues<EmailHeader>(EmailHeader.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"security", n => { Security = n.GetEnumValue<EmailSecurityType>(); } },
                ...
                {"unverified", n => { Unverified = n.GetObjectValue<EmailUnverifiedOptions>(EmailUnverifiedOptions.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<EmailHeader>("additionalHeaders", AdditionalHeaders);
            ...
            writer.WriteEnumValue<EmailSecurityType>("security", Security);
            ...
            writer.WriteObjectValue<EmailUnverifiedOptions>("unverified", Unverified);
